oh-my-posh init pwsh --config 'C:\Users\user\.oh-my-posh\config.json' | Invoke-Expression

function h() { & helm $args }
function hup() { & helm upgrade --install $args }
function hrm() { & helm uninstall $args }
function hupn() { & helm upgrade --install --namespace $args }
function hrmn() { & helm uninstall --namespace $args }
function hl() { & helm list $args }
function hla() { & helm list --all-namespaces $args }
function hln() { & helm list --namespace $args }
...
function kgev() { & kubectl get events $args }
